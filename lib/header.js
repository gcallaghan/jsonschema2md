...
var { getAbstract } = require('./abstract.js');
...
function schemaProps(schema, schemaPath, filename) {
  const abstract = getAbstract(schema);
  console.log('ABSTRACT', !_.isEmpty(abstract));
  console.log(abstract);
  return {
    // if there are definitions, but no properties
    abstract: _.isEmpty(abstract) ? 'Can be instantiated' : 'Cannot be instantiated',
